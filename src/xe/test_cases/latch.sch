...
C {sky130_stdcells/inv_1.sym} 160 -210 0 0 {name=x1 VGND=vcc VNB=vcc VPB=vss VPWR=vss prefix=sky130_fd_sc_hd__ }
C {yxt/tgate.sym} 220 -150 0 0 {name=x2 vcc=vcc vss=vss}
C {sky130_stdcells/inv_1.sym} 400 -210 0 0 {name=x3 VGND=vcc VNB=vcc VPB=vss VPWR=vss prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_1.sym} 160 -290 0 0 {name=x6 VGND=vcc VNB=vcc VPB=vss VPWR=vss prefix=sky130_fd_sc_hd__ }
...
C {sky130_stdcells/inv_1.sym} 400 -130 0 0 {name=x4 VGND=vcc VNB=vcc VPB=vss VPWR=vss prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_1.sym} 400 -70 0 1 {name=x5 VGND=vcc VNB=vcc VPB=vss VPWR=vss prefix=sky130_fd_sc_hd__ }
