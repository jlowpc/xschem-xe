...
C {sky130_stdcells/and2_0.sym} 440 -180 0 0 {name=x3 VGND=vss VNB=vss VPB=vcc VPWR=vcc prefix=sky130_fd_sc_hd__ }
C {yxt/dyn.sym} 190 -130 0 0 {name=x4 vcc=vss vss=vss}
